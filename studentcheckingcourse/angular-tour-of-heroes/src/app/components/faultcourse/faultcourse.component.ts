...
@Component({
  selector: 'app-faultcourse',
  templateUrl: './faultcourse.component.html',
  styleUrls: ['./faultcourse.component.scss']
})
export class FaultcourseComponent implements OnInit {
  ...
  elements: any = [
    { id: 'SWE62-325', name: 'Software Practice', unit: '3', year: '2564', term: '1' },
    { id: 'SWE62-351', name: 'Software Testing', unit: '3', year: '2564', term: '1' },
  ];

  headElements = ['รหัสวิชา', 'ชื่อรายวิชา', 'หน่วยกิต', 'ปีการศึกษาที่จะเปิดสอน', 'ภาคการศึกษาที่จะเปิดสอน'];
