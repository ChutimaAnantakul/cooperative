...
@Component({
  selector: 'app-passcourse',
  templateUrl: './passcourse.component.html',
  styleUrls: ['./passcourse.component.scss']
})
export class PasscourseComponent implements OnInit {
  ...
  elements: any = [
    { id: 'SWE62-206', name: 'object oriented programming', unit: '4', year: '2562', term: '2' },
  ];

  headElements = ['รหัสวิชา', 'ชื่อรายวิชา', 'หน่วยกิต', 'ปีการศึกษาที่เรียน', 'ภาคการศึกษาที่เรียน'];
